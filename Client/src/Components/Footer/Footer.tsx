        ...
        <div className={styles.footer}>
            <div className={styles.topLevel}>
                <div className={styles.words}>
                    <h2 className={styles.wordsHeader}>Sign Up To Our Newsletter.</h2>
                    <p className={styles.wordsMini}>Be the first to hear about the latest offers.</p>
                </div>
                <form className={styles.emailSendForm}>
                    <InputFooter/>
                    <div className={styles.butField}><Button butContent = "Subscribe"/></div>
                </form>
            </div>
            ...
            <div className={styles.contacts}>
                <div className={styles.icons}>
                    ...
                    <img className={styles.icon} src={Instagram} alt="IG link"/>
                </div>
