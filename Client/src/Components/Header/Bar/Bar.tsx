...
const Bar = () => {
    ...
    return (
        <div className={styles.mainContainer}>
            ...
            >
                <NavLink to="/tools" className={styles.link} onClick={(): void => {
                    setActive(0);
                }}>Tools</NavLink>
            </div>
            <div
            ...
            >
                <NavLink to="/supplies" className={styles.link} onClick={(): void => {
                    setActive(1);
                }}>Supplies</NavLink>
            </div>
            <div
            ...
            >
                <NavLink to="/service" className={styles.link}  onClick={(): void => {
                    setActive(2);
                }}>Service</NavLink>
            </div>
            <div
            ...
            >
                <NavLink to="/rent" className={styles.link} onClick={(): void => {
                    setActive(3);
                }}>Rent</NavLink>
            </div>
            <div
            ...
            >
                <NavLink to="/" className={styles.link} onClick={(): void => {
                    setActive(4);
                }}>Our deals</NavLink>
            </div>
        </div>
