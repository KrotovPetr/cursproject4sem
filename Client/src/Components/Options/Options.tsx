        ...
        <div className={styles.optionsContainer}>
            <div className={styles.options}>
                <div className={styles.option}>
                    ...
                    <p className={styles.pText}>Up to 3 years on-site warranty available for your peace of mind.</p>
                </div>
                <div className={styles.option}>
                    <div className={styles.icon}>
                        <img src={PerAcc} alt='PersAcc' className={styles.image}/>
                    </div>
                    <h4 className={styles.hText}>Personal Account</h4>
                    <p className={styles.pText}>With big discounts, free delivery and a dedicated support specialist.</p>
                </div>
                <div className={styles.option}>
                    <div className={styles.icon}>
                    ...
                    <p className={styles.pText}>Up to 70% off new Products, you can be sure of the best price.</p>
                </div>
            </div>
        </div>
    );
