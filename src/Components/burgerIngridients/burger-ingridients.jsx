...
const BurgerIngridients = (props) => {
    ...
    return (
        <div className={ingredientsBurger.constructor}>
            <h1 className={ingredientsBurger.appText}>
                Соберите заказ
            </h1>
            ...
            <section className={ingredientsBurger.menu}>
                ...
                <section>
                    <p className={ingredientsBurger.headerText}  id="bun">
                        Булки
                    </p>
                ...
                <section>
                    <p className={ingredientsBurger.headerText}  id="sauce">
                        Соусы
                    </p>
                    <div className={ingredientsBurger.cardList}>
                        <IngredientList
                ...
                <section>
                    <p className={ingredientsBurger.headerText} id="main">
                        Начинки
                    </p>
                    <div className={ingredientsBurger.cardList}>
                        <IngredientList
